...
module.exports = {
  // SupportTicket Model
  SupportTicket: sequelize.MAIN_DB_NAME.define(
    'support_tickets',
    {
      support_ticket_id: {
  ...
  // TicketMessage Model
  TicketMessage: sequelize.MAIN_DB_NAME.define(
    'ticket_messages',
    {
      ticket_message_id: {
        type: DataTypes.INTEGER,
  ...
  TicketAttachment: sequelize.MAIN_DB_NAME.define(
    'ticket_attachments',
    {
  ...
  // FAQ Model
  FAQ: sequelize.MAIN_DB_NAME.define(
    'faqs',
    {
      faq_id: {
        type: DataTypes.INTEGER,
